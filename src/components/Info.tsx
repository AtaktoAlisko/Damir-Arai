...
export default function Info() {
  ...
  const calculateTimeLeft = () => {
    ...
    const difference = +new Date(`${year}-09-21`) - +new Date();
    let timeLeft = {};
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      >
        Қызылорда қаласы, <br /> &quot;DARIYA &quot; <br /> мейрамханасы
      </div>
      <div
        data-aos="fade-up"
      ...
      <div className="ml-10 flex gap-10">
        <a href="https://2gis.kz/kyzylorda/firm/70000001077453606">
          <Image
            data-aos="fade-up"
            src="/2gis.jpeg"
            alt="2gis"
        ...
        <a href="https://www.instagram.com/dariya_grandballroom">
          <Image
            data-aos="fade-up"
            src={insta}
            alt="insta"
